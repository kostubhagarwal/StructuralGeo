...
p.add_point_labels((-3,-3,4), ["Feature Plane"], italic=False, bold=True, show_points=False, font_size=16, text_color='black',
                   shape_color='grey', shape='rounded_rect', fill_shape=True, margin=3, shape_opacity=.1,)
p.add_point_labels((3,-1,0), ["Horizon Plane"], italic=False, bold=True, show_points=False, font_size=16, text_color='black',
                   shape_color='grey', shape='rounded_rect', fill_shape=True, margin=3, shape_opacity=.1,)
...
p.add_legend(bcolor='white', border=True, size=[0.2, 0.2], loc = 'center right')

_ = p.add_axes(line_width=6)
p.show_bounds(
    grid=False, 
    location='outer', 
    ticks='outside',
    n_xlabels=0, 
    n_ylabels=0, 
    n_zlabels=0,  # Set number of z labels to 0 to hide z-axis labels
    font_size=12,
...
p.show()
p.screenshot("strike-dip-rake.png")